...
type CreateGroupRequest struct {
	...
	AvatarColor   string                 `protobuf:"bytes,5,opt,name=avatar_color,json=avatarColor,proto3" json:"avatar_color,omitempty"`
	AvatarFile    string                 `protobuf:"bytes,6,opt,name=avatar_file,json=avatarFile,proto3" json:"avatar_file,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateGroupRequest) GetAvatarColor() string {
	if x != nil {
...
func (x *CreateGroupRequest) GetAvatarFile() string {
	if x != nil {
		return x.AvatarFile
	}
	return ""
...
const file_proto_chat_chat_proto_rawDesc = "" +
	...
	"\x06groups\x18\x01 \x03(\v2\v.chat.GroupR\x06groups\"\xc0\x01\n" +
	...
	"\favatar_color\x18\x05 \x01(\tR\vavatarColor\x12\x1f\n" +
	"\vavatar_file\x18\x06 \x01(\tR\n" +
	"avatarFile\"0\n" +
	...
	"\x02ok\x18\x01 \x01(\bR\x02ok2\xf4\x04\n" +
	"\vChatService\x129\n" +
	...
	"\vCreateGroup\x12\x18.chat.CreateGroupRequest\x1a\x19.chat.CreateGroupResponse\x12B\n" +
	"\vDeleteGroup\x12\x18.chat.DeleteGroupRequest\x1a\x19.chat.DeleteGroupResponse\x12N\n" +
...
var file_proto_chat_chat_proto_goTypes = []any{
	...
	(*DeleteGroupRequest)(nil),        // 18: chat.DeleteGroupRequest
	(*DeleteGroupResponse)(nil),       // 19: chat.DeleteGroupResponse
}
var file_proto_chat_chat_proto_depIdxs = []int32{
	...
	18, // 8: chat.ChatService.DeleteGroup:input_type -> chat.DeleteGroupRequest
	14, // 9: chat.ChatService.GetParticipants:input_type -> chat.GetParticipantsRequest
	16, // 10: chat.ChatService.UpdateLastMessage:input_type -> chat.UpdateLastMessageRequest
	2,  // 11: chat.ChatService.GetChats:output_type -> chat.GetChatsResponse
	4,  // 12: chat.ChatService.CreateChat:output_type -> chat.CreateChatResponse
	6,  // 13: chat.ChatService.DeleteChat:output_type -> chat.DeleteChatResponse
	8,  // 14: chat.ChatService.ClearChat:output_type -> chat.ClearChatResponse
	11, // 15: chat.ChatService.GetGroups:output_type -> chat.GetGroupsResponse
	13, // 16: chat.ChatService.CreateGroup:output_type -> chat.CreateGroupResponse
	19, // 17: chat.ChatService.DeleteGroup:output_type -> chat.DeleteGroupResponse
	15, // 18: chat.ChatService.GetParticipants:output_type -> chat.GetParticipantsResponse
	17, // 19: chat.ChatService.UpdateLastMessage:output_type -> chat.UpdateLastMessageResponse
