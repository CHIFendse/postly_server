...
func (x *SetCredentialsRequest) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *SetCredentialsRequest) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
func (x *SetCredentialsResponse) GetOk() bool {
	if x != nil {
		return x.Ok
	}
	return false
...
const file_proto_auth_auth_proto_rawDesc = "" +
	...
	"\x15SetCredentialsRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\"(\n" +
	"\x16SetCredentialsResponse\x12\x0e\n" +
	...
	"\auser_id\x18\x02 \x01(\tR\x06userId2\xd6\x01\n" +
	"\vAuthService\x12K\n" +
	"\x0eSetCredentials\x12\x1b.auth.SetCredentialsRequest\x1a\x1c.auth.SetCredentialsResponse\x120\n" +
...
var file_proto_auth_auth_proto_goTypes = []any{
	(*SetCredentialsRequest)(nil),  // 0: auth.SetCredentialsRequest
	(*SetCredentialsResponse)(nil), // 1: auth.SetCredentialsResponse
...
var file_proto_auth_auth_proto_depIdxs = []int32{
	0, // 0: auth.AuthService.SetCredentials:input_type -> auth.SetCredentialsRequest
	...
	1, // 3: auth.AuthService.SetCredentials:output_type -> auth.SetCredentialsResponse
